...
void img_callback(const sensor_msgs::ImageConstPtr &img_msg)
{
    ...
    TicToc t_r;
    for (int i = 0; i < NUM_OF_CAM; i++)//判断相机数目，VINS为单目
    {
...
int main(int argc, char **argv)
{
    ...
    // 注册一些publisher
    pub_img = n.advertise<sensor_msgs::PointCloud>("feature", 1000); // 因为前面带的是n. 命名空间，实际发出去的是 /feature_tracker/feature
